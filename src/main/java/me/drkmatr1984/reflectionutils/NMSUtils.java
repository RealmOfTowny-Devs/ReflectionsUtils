...
public class NMSUtils {
    ...
    protected static Class<?> class_TileEntitySkull;
    ...
    protected static Method class_TileEntitySkull_getGameProfileMethod;
    protected static Method class_TileEntitySkull_setGameProfileMethod;
    ...
    protected static Constructor class_TileEntitySkull_Constructor;
    ...
    static
    {
        ...
        try {
            ...
            class_TileEntitySkull_getGameProfileMethod = class_TileEntitySkull.getMethod("getGameProfile");
            class_TileEntitySkull_setGameProfileMethod = class_TileEntitySkull.getMethod("setGameProfile", GameProfile.class);
            ...
            class_TileEntitySkull = fixBukkitClass("net.minecraft.server.TileEntitySkull");
            ...
            class_TileEntitySkull_Constructor = class_TileEntitySkull.getConstructor();
